                ...
                <Card className="flex w-full flex-row justify-between rounded-lg border border-gray-200 px-5 py-1 shadow-none">
                    ...
                    <div className="w-full p-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-[150px] space-y-2 py-4 px-0 shadow-lg">
                    ...
                    <div className="w-full p-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-90 p-3 shadow-lg">
                                {["All Meter", "6201021224", "6201021223", "6201021225", "6201021226", "6201021256"].map(
                                    (option) => (
                                        <DropdownMenuItem
                                            key={option}
                                        ...
                                        >
                                            <span>{option}</span>
                                            <div
                                                className={`flex h-5 w-5 items-center justify-center rounded-lg border transition-colors ${meter === option
