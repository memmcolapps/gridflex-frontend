...
const initialMeters: MeterData[] = [
  ...
  {
    id: "7",
    meterNumber: "61245269529",
    manufactureName: "Mojec",
    class: "MD",
    meterType: "Electricity",
    category: "Postpaid",
    dateAdded: "09-04-2025",
  ...
  {
    id: "10",
    meterNumber: "61245269532",
    manufactureName: "Heixing",
    class: "MD",
    meterType: "Electricity",
    category: "Postpaid",
    dateAdded: "09-04-2025",
...
export default function MeterInventoryPage() {
  ...
  const isAllSelected =
    meters.length > 0 && selectedMeters.length === meters.length;
  ...
  const handleAllocate = () => {
    console.log("handleAllocate called with:", {
      selectedMeter,
      organizationId,
    }); // Debugging
    if (!selectedMeter) {
  ...
  const handleSetActiveFilters = (filters: Record<string, boolean>) => {
    ...
    filtered = filtered.filter((meter) => {
      ...
      const classMatch =
        ...
        (filters.singlePhase &&
          meter.class.toLowerCase().includes("single phase")) ??
        (filters.threePhase &&
          meter.class.toLowerCase().includes("three phase")) ??
