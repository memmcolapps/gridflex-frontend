...
export default function MeterConsumptions({
  searchQuery,
  sortConfig,
  selectedMonth,
  selectedYear,
  meterClass,
}: MeterConsumptionsProps) {
  ...
  const isAllSelected =
    ...
    consumptions.every((item) => selectedRowIds.has(item.id));
            ...
            {consumptions.length === 0 ? (
              ...
              consumptions.map((item, index) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="py-3">{item.meterNumber}</TableCell>
                  <TableCell className="py-3">{item.feederName}</TableCell>
                  <TableCell className="py-3">{item.tariffType}</TableCell>
                  <TableCell className="py-3">
                  ...
                  <TableCell className="py-3">{item.currentReading}</TableCell>
                  <TableCell className="py-3">{item.readingType}</TableCell>
                  <TableCell className="py-3">{item.consumption}</TableCell>
                </TableRow>
              ))
            )}
          </TableBody>
