...
const AdjustmentTable: React.FC<AdjustmentTableProps> = ({ type }) => {
    ...
    const [creditTransactions] = useState<Transaction[]>([
        { date: '05-05-2025', liabilityCause: 'Electricity Deficit', liabilityCode: 'CR1234', credit: 500000, debit: 100000, balance: 10000 },
        { date: '05-04-2025', liabilityCause: 'Other Reason', liabilityCode: 'CR1234', credit: 400000, debit: 10000, balance: 0 },
        { date: '05-03-2025', liabilityCause: 'Other Reason', liabilityCode: 'CR1234', credit: 10000, debit: 10000, balance: 10000 },
        { date: '05-02-2025', liabilityCause: 'Other Reason', liabilityCode: 'CR1234', credit: 300000, debit: 10000, balance: 0 },
    ]);

    const [debitTransactions] = useState<Transaction[]>([
        { date: '05-05-2025', liabilityCause: 'Bypass', liabilityCode: 'C90bqt', credit: '', debit: 500000, balance: 500000 },
        { date: '05-04-2025', liabilityCause: 'Meter Refund', liabilityCode: 'C90bqt', credit: 100000, debit: '', balance: 400000 },
        { date: '05-03-2025', liabilityCause: 'Capme', liabilityCode: 'C90bqt', credit: 100000, debit: '', balance: 300000 },
        { date: '05-02-2025', liabilityCause: 'Outstanding Bills', liabilityCode: 'C90bqt', credit: 100000, debit: '', balance: 200000 },
        { date: '05-01-2025', liabilityCause: 'Payment', liabilityCode: 'C90bqt', credit: 100000, debit: '', balance: 100000 },
        { date: '04-30-2025', liabilityCode: 'C90bqt', liabilityCause: 'Payment', credit: 100000, debit: '', balance: 0 },
        { date: '04-29-2025', liabilityCause: 'New Debit', liabilityCode: 'C90bqt', credit: '', debit: 500000, balance: 500000 },
    ]);
