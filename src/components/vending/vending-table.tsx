...
const VendingTable = ({
  ...
  return (
    <div className="w-full">
      <Card className="mb-4 rounded-lg border-gray-100 p-4 shadow-sm">
        <Table>
            ...
            {isLoading ? (
              ...
              paginatedTransactions.map((transaction, index) => (
                <TableRow key={transaction.transactionId}>
                  ...
                  <TableCell>
                    <span
                      className={`rounded-full px-2 py-1 ${getStatusColor(transaction.status)}`}
                    >
                      {transaction.status}
                    </span>
                  </TableCell>
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="cursor-pointer ring-gray-200/20 hover:bg-gray-100 focus:bg-gray-100"
                          >
      ...
      <Dialog open={showTokenDialog} onOpenChange={setShowTokenDialog}>
        <DialogContent className="h-fit w-full bg-white">
          <DialogHeader>
            <DialogTitle>
              {selectedTransaction &&
                getTitleCase(selectedTransaction.tokenType)}
            </DialogTitle>
          </DialogHeader>
                  ...
                  try {
                    const payload = {
                      id:
                        ...
                        (selectedTransaction as VendingTransaction).id,
                                                ...
                                                <div class="receipt">
                                                    ...
                                                    <div class="amount-section">
                                                        ...
                                                        <div class="info-row">
                                                            ...
                                                            <span class="value">₦${(Array.isArray(
                                                              selectedTransaction?.creditAdjustment,
                                                            )
                                                              ? selectedTransaction
                                                                  .creditAdjustment
                                                                  .length > 0
                                                                ? selectedTransaction.creditAdjustment.reduce(
                                                                    (
                                                                      sum,
                                                                      val,
                                                                    ) =>
                                                        ...
                                                        <div class="info-row">
                                                            ...
                                                            <span class="value">₦${(Array.isArray(
                                                              selectedTransaction?.debitAdjustment,
                                                            )
                                                              ? selectedTransaction
                                                                  .debitAdjustment
                                                                  .length > 0
                                                                ? selectedTransaction.debitAdjustment.reduce(
                                                                    (
                                                                      sum,
                                                                      val,
                                                                    ) =>
