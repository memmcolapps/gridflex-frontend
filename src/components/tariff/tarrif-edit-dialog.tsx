...
export function EditTariffDialog({ open, onOpenChange, tariff, onSave }: EditTariffDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[400px] bg-white p-6 rounded-lg shadow-md">
                <DialogHeader>
                    <DialogTitle className="text-lg font-semibold">Edit Tariff</DialogTitle>
                </DialogHeader>
